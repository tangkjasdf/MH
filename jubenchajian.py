...
dddd = "本插件完全免费，唯一b站作者[咸蛋巴拉巴]！---  [作者q群：668311397]"
...
class Script(scripts.Script):
    def title(self):    
        return "AI漫画助手v3.0 -【如果你喜欢本工具，加q群668311397交流AI漫画，还能免费获取作者的模型】--[b站作者-咸蛋巴拉巴]"
    
    def ui(self, is_img2img):       
        
        with gr.Row():
            xtf = gr.Dropdown(label="选择作者画风（预设）-- [如果无效说明模型不包含这类数据]", choices=[" - 无","Loish - 创新者", "Kim Jung Gi - 无限想象", "Artgerm - 超级女孩", "Sakimichan - 魔法奇谭", "James Paick - 未来科技", "Jock - 末日幸存者", "Bang Sangho - 斗鱼", "Stanley Lau - 正义联盟", "Yuehui Tang - 神话世界", "Krenz Cushart - 战斗机甲","WLOP - 粉色噩梦", "Guweiz - 幸存者", "Fishball - 三体：死神永生", "Loish - 梦境之旅", "Artgerm - 帝国的崛起", "Hoon - 地球之子", "Kuvshinov Ilya - 暗影猎人", "Redjuice - 遥远的未来", "Koyorin - 星际公主", "Sakimichan - 龙珠：超级赛亚人","James Paick - 星际之战", "Sparth (Nicolas Bouvier) - 未来城市", "Craig Mullins - 地球未来", "Ryan Meinerding - 漫威电影", "John Wallin Liberto - 外星空间", "Fenghua Zhong - 远古王朝", "Mike Nash - 魔法学院", "Sergey Kolesov - 超现实幻想", "Eytan Zana - 极光奇观", "Simon Weaner - 反乌托邦世界","Stanley Lau - 神奇女侠: 马蒂斯之死", "Brom - 黑暗精灵", "Jock - 蝙蝠侠: 黑暗骑士归来", "Oliver Coipel - 金刚", "Beksinski - 外星人", "Yoshitaka Amano - 尤迪安", "Kekai Kotaki - 龙族起源", "Sachin Teng - 雪之女王", "Jasmine Becket-Griffith - 魔法国度", "Pascal Blanche - 星际探险家","Joakim Ericsson - 阿拉德历险记", "Jesper Ejsing - 龙与地下城", "Ian McQue - 星际迷航", "Ryan Meinerding - 钢铁侠：英雄崛起", "Kekai Kotaki - 光与暗的传说", "Ruan Jia - 火影忍者", "Bastien Lecouffe Deharme - 神话传说", "Ryan Lang - 奇幻森林", "Daniel Kamarudin - 《魔兽世界》", "Eytan Zana - 未来战士","Stan Lee - 蜘蛛侠、钢铁侠、雷神等漫威英雄", "Todd McFarlane - 脊柱之战、自杀小队", "Neil Gaiman - 沙曼、无人洛城", "Dave Gibbons - 世纪杀手", "Frank Miller - 蝙蝠侠：黑暗骑士归来、罪恶之城", "Bill Watterson - 柯南·伊素格、公园和斯皮格", "Osamu Tezuka - 铁臂阿童木、星球大战、菠萝超人", "Hayao Miyazaki - 龙猫、天空之城、千与千寻", "Robert Crumb - 乌托邦", "Al Hirschfeld - 百老汇剧院的演员插画","Daniel Danger - 最后生还者 (插画师)", "Dave Rapoza - 忍者神龟 (插画师)", "Jessica Hische - 企鹅出版社 (插画师)", "Jock - 蝙蝠侠 (插画师)", "Ken Taylor - 盗梦空间 (插画师)", "Lauren Hom - 谷歌 (插画师)", "Loish - Wacom (插画师)", "Mike Mitchell - 漫威 (插画师)", "Shantell Martin - 纽约城市芭蕾舞团 (插画师)", "Stephen Bliss - 侠盗猎车手 (插画师)","Steve Prescott - 战锤","Yoshitaka Amano - 最终幻想", "Akira Toriyama - 龙珠", "Hayao Miyazaki - 千与千寻", "Osamu Tezuka - 铁臂阿童木", "Masamune Shirow - 攻壳机动队", "Takehiko Inoue - 灌篮高手", "Katsuhiro Otomo - AKIRA", "Tsutomu Nihei - BLAME!", "Kazuo Umezu - 漂流教室", "Hirohiko Araki - JoJo的奇妙冒险", "Rei Hiroe - 黑色底盘", "Yusuke Murata - 一拳超人", "Kentaro Miura - 烙印勇士", "Fumiya Sato - 杀戮都市", "Naoki Urasawa - MONSTER", "Tite Kubo - 死神", "Hiromu Arakawa - 钢之炼金术师", "Takeshi Obata - 死亡笔记", "CLAMP collective - 魔卡少女樱", "Rumiko Takahashi - 犬夜叉","Ralph McQuarrie - 星球大战", "Syd Mead - 洛城机密", "Rick Baker - 狼人、星际迷航", "H.R. Giger - 异形", "Jean Giraud (Moebius) - 第五元素", "Yoshitaka Amano - 最终幻想", "Geof Darrow - 黑客帝国", "Nilo Rodis-Jamero - 星球大战", "Doug Chiang - 星球大战、阿凡达", "John Howe - 魔戒", "Alan Lee - 魔戒、霍比特人", "Stuart Craig - 哈利波特", "Kevin O'Neill - 世纪之战", "Alex McDowell - 迷雾之城", "Ken Adam - 詹姆斯•邦德系列电影","CLAMP - 经久纱流、大场水滸传、某个科学的超电磁炮", "Koyoharu Gotouge - 鬼灭之刃", "Hajime Isayama - 进击的巨人", "Mitsuru Adachi - 双截龙", "Inio Asano - 国王游戏、好想告诉你", "Yusei Matsui - 暗杀教室", "Junji Ito - Uzumaki、镰仓物语、恶魔之谷", "Hiro Mashima - FAIRY TAIL、EDENS ZERO", "Kohei Horikoshi - 像素英雄", "Aka Akasaka - 与谍同谋、被讨厌的松本同学", "Kentarō Miura - 灌篮高手、小说家、新暗行御史", "Kengo Hanazawa - 吃人鬼、我与僵尸有个约会", "Yuki Tabata - 黑色五叶草", "Gege Akutami - 呪術廻戦", "Kousuke Oono - 一弹起始、蓝天航线", "Akiko Higashimura - 刺客伍六三、东京女子图鉴、虚构推理", "Io Sakisaka - 好想告诉你、罗曼蒂克的玩具、Honey and Clover", "Haruko Ichikawa - 一人之下、千古王者、山海情", "Haruka Kanda - 紫罗兰永恒花园、花开伊吕波、猎魔人", "Miyuki Nakayama - 战斗陀螺、洛克人X", "Paru Itagaki - 社长，戏说社员的恋爱", " Kouhei Aonishi - 大声展开！伸展吧！我的腰椎、钓鱼之夏、深夜食堂", "Fujimoto Tatsuki - 鬼滅之刃 炭治郎外传 悲伤之刃、CHAINSAWMAN", "Yuito Kimura - 重新起航的天之歌、谷底的那一抹阳光、白色相簿2", "Yuji Kaku - 圣断罗斯之魔女、绝命诗1816、麻衣的宇宙奇幻之旅","Yoshitaka Amano - 宝石之国（插画师）", "Range Murata - 最终幻想XII、法师与猫（插画师）", "Kazuki Takahashi - 游戏王（插画师）", "Akihiko Yoshida - 光之海（插画师）", "Shunya Yamashita - 信长之野望Online、绝对领域战争（插画师）", "Tony Taka - 无双OROCHI系列、Fault！（插画师）", "Nishikiito - 食戟之灵（插画师）", "REDJUICE - Guilty Crown、Beatless（插画师）", "WIT STUDIO - 进击的巨人、在下坂本，有何贵干？（动画公司）", "Hiroshi Nagai - F-1 Grand Prix、F-1 Hero（插画师）", "HACCAN - 武器种族传说、墓之沙（插画师）", "Kisai Takayama - 魔卡少女樱、魔法骑士雷阿斯（插画师）", "CLAMP - 神之塔（插画师）", "Yuka Nakajima - Fate/Grand Order、乐园追放（插画师）", "Akiman - 街头霸王（插画师）", "Shigenori Soejima - 女神异闻录系列、CATHERINE FULL BODY（插画师）", "Koyori - 只有我能进入的隐藏迷宫（插画师）", "Oyari Ashito - 学院黙示录、英雄伝説 空の軌跡（插画师）", "Sakura Hanpen - 干支魂（插画师）", "Yoshinori Shizuma - 决斗！平安京、罪人与龙（插画师）"], value="Koyori - 只有我能进入的隐藏迷宫（插画师）", elem_id=self.elem_id("xtf")) 
            rtf = gr.Dropdown(label="选择时代背景（预设）", choices=[" - 无","Middle Ages - 中世纪", "Renaissance - 文艺复兴", "Meiji Period - 日本明治時代", "Industrial Revolution - 工业革命", "Edo Period - 日本江戸時代", "Roaring Twenties - 繁华的二十年代", "Cold War era - 冷战时期", "Information Age - 信息时代", "Song Dynasty - 中华宋朝", "Digital Age - 数字时代", "Warring States Period - 中华战国时期","Bronze Age - 青铜时代", "Iron Age - 铁器时代", "Classical Antiquity - 古典时代", "Victorian Era - 维多利亚时代", "Gilded Age - 镀金时代", "Jazz Age - 爵士时代", "Space Age - 太空时代", "Ancient Egypt - 古埃及", "Golden Age of Hollywood - 好莱坞黄金时代", "Tang Dynasty - 中华唐朝", "Post-Modernism - 后现代主义", "Era of Good Feelings - 平和年代", "Age of Enlightenment - 启蒙时代", "Gothic Period - 哥特式时期", "Age of Exploration - 探险时代", "Art Nouveau - 新艺术运动", "Ming Dynasty - 中华明朝", "Atomic Age - 原子时代", "Baroque Period - 巴洛克时期", "Modernism - 现代主义"], value="Digital Age - 数字时代", elem_id=self.elem_id("rtf")) 
       ...
       #     btf = gr.Dropdown(label="选择漫画类型（预设）", choices=[" - 无","Shonen Manga - 少年漫画","Shojo Manga - 少女漫画","Seinen Manga - 青年漫画","Science Fiction Manga - 科幻漫画","Gekiga - 剧情漫畫","Kodomomuke Manga - 儿童漫画","Fantasy Manga - 奇幻漫画","Horror Manga - 恐怖漫画","Sports Manga - 运动漫画", "Yaoi Manga - 耽美漫画","Yuri Manga - 百合漫画",], value="Shonen Manga - 少年漫画", elem_id=self.elem_id("rtf"))  
        ...
        PTX = gr.Textbox(label="列表输入，这里输入批处理文本或者剧本，每行会输出一张图。【推荐使用GPT来写分镜，一段一个分镜】【推荐画布尺寸：300*450，450*300 高清就开放大】", value = qqta ,lines=1, elem_id=self.elem_id("PTX"))
        with gr.Row():
        ...
        return [ PTX, style_txt, flow_text,ow_text,seedX,CX1,CX2,CX3,CXt,MXT,fast,ttm,tttr,txtt,xtf,rtf,CX5,CXx,M1,M2,M3,M4]
 
       
    def run(self, p, PTX: str, style_txt: str, flow_text: str, ow_text: str,seedX: int,CX1: bool,CX2: bool,CX3: bool,CXt: bool,MXT: int,fast: int,ttm: int,tttr: int, txtt: int,xtf:str,rtf:str,CX5: bool,CXx: bool, M1: str, M2: str, M3: str, M4: str):
        global ppt, dddf
       ...
       # mcc = get_name(stf)
        ...
        for n, args in enumerate(jobs):
            ...
            args["prompt"] = kkkk(args["prompt"],c1 + c2 + c3 + c4)
            print( "-----准备开始处理任务：",n+1)
            copy_p = copy.copy(p)   
            ...
            images += proc.images
            print(dddd+"   处理了一张图. seed值为:",copy_p.seed)
